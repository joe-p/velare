...
circom --r1cs --wasm --c --sym --inspect $CIRCUITS_DIR/transfer.circom --prime bls12381 -o out
pnpm snarkjs plonk setup $CIRCUITS_DIR/out/transfer.r1cs $CIRCUITS_DIR/setup/pot16_final.ptau $CIRCUITS_DIR/zkeys/transfer.zkey
